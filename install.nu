...
if $is_linux or $is_macos {
  $requirements = $requirements | insert autoconf { "autoconf" }
  $requirements = $requirements | insert gawk { "gawk" }
}
mut missing = []
...
download https://raw.githubusercontent.com/tani/vim-jetpack/master/plugin/jetpack.vim ~/.local/share/nvim/site/pack/jetpack/opt/vim-jetpack/plugin/jetpack.vim
